...
insert into public.datapoints_taxonomia (codigo, norma, pilar, seccion_indice, descripcion, ods) values
  ...
  ('NIIF S1 27(a)(v)', 'S1', 'gobernanza', '1. La organización y su prácticas de presentación de informes', 'Cómo supervisa el órgano u órganos o las personas el establecimiento de objetivos relacionados con los riesgos y oportunidades de sostenibilidad y cómo controlan los avances hacia su consecución (véase el párrafo 51), incluyendo si las métricas de desempeño relacionadas se incluyen en las políticas de remuneración y de qué manera.', null),
  ('NIIF S1 27(b)', 'S1', 'gobernanza', '1. La organización y su prácticas de presentación de informes', 'El papel de la gerencia en los procesos de gobernanza, los controles y los procedimientos utilizados para vigilar, gestionar y supervisar los riesgos y las oportunidades relacionados con la sostenibilidad.', null),
  ('NIIF S1 27(b)(i)', 'S1', 'gobernanza', '1. La organización y su prácticas de presentación de informes', 'Si la función se delega en un cargo específico a nivel de gestión o en un comité a nivel de gestión, y cómo se ejerce la supervisión sobre dicho cargo o comité.', null),
  ('NIIF S1 30(a)y(b)', 'S1', 'estrategia', '2. Actividades y trabajadores', 'Descripción de los riesgos y oportunidades relacionados con la sostenibilidad que podría esperarse razonablemente que afecten a las perspectivas de la entidad, y los horizontes temporales —corto, medio o largo plazo— en los que cabe esperar razonablemente que se produzcan sus efectos.', null),
  ...
  ('NIIF S1 32(a)', 'S1', 'estrategia', '2. Actividades y trabajadores', 'Descripción de los efectos actuales y previstos de los riesgos y oportunidades relacionados con la sostenibilidad sobre el modelo de negocio y la cadena de valor de la entidad.', null),
  ...
  ('NIIF S1 35(a)', 'S1', 'estrategia', '2. Actividades y trabajadores', 'Cómo los riesgos y oportunidades relacionados con la sostenibilidad han afectado a su situación financiera, rendimiento financiero y flujos de efectivo durante el periodo sobre el que se informa.', '8. Trabajo decente y crecimiento económico'),
  ...
  ('NIIF S1 35(c)(i)(ii)', 'S1', 'estrategia', '3. Gobernanza', 'Cómo espera la entidad que cambie su situación financiera a corto, medio y largo plazo, dada su estrategia para gestionar los riesgos y oportunidades de sostenibilidad, considerando (i) sus planes de inversión y disposición —incluidos aquellos con los que no esté comprometida contractualmente— y (ii) sus fuentes de financiación previstas para implementar su estrategia.', null),
  ('NIIF S1 35(d)', 'S1', 'estrategia', '3. Gobernanza', 'Cómo espera la entidad que cambien su rendimiento financiero y sus flujos de efectivo a corto, medio y largo plazo, dada su estrategia para gestionar los riesgos y oportunidades relacionados con la sostenibilidad.', '16. Paz, justicia e instituciones sólidas'),
  ('NIIF S1 40(a)', 'S1', 'estrategia', '3. Gobernanza', 'Explicación de por qué no se proporcionó información cuantitativa sobre los efectos financieros actuales o previstos de un riesgo o oportunidad identificado', null),
  ...
  ('NIIF S1 74', 'S1', 'metricas', '3. Gobernanza', 'Los juicios —distintos de los que implican estimaciones de importes— realizados en el proceso de preparación de la información a revelar sobre sostenibilidad y que tengan el efecto más significativo sobre la información incluida en ella.', null),
  ...
  ('NIIF S2 14(a)(iv)', 'S2', 'estrategia', '4. Estrategia, políticas y prácticas', 'Cualquier plan de transición relacionado con el clima que tenga la entidad, incluida la información sobre los supuestos clave utilizados en su desarrollo y las dependencias en las que se basa.', null),
  ('NIIF S2 14(a)(v)', 'S2', 'estrategia', '4. Estrategia, políticas y prácticas', 'Cómo prevé la entidad alcanzar cualquier objetivo relacionado con el clima, incluido cualquier objetivo de emisiones de gases de efecto invernadero, descrito de conformidad con los párrafos 33 a 36.', null),
  ...
  ('NIIF S2 16(a)', 'S2', 'estrategia', '5. Participación de los grupos de interés', 'Cómo los riesgos y oportunidades relacionados con el clima han afectado a su situación financiera, rendimiento financiero y flujos de efectivo durante el periodo sobre el que se informa.', null),
  ...
  ('NIIF S2 16(c)(i)(ii)', 'S2', 'estrategia', '6. Contenidos sobre los temas materiales', 'Cómo espera la entidad que cambie su situación financiera a corto, medio y largo plazo, dada su estrategia para gestionar los riesgos y oportunidades relacionados con el clima, considerando (i) sus planes de inversión y disposición, incluidos aquellos con los que no esté comprometida contractualmente, y (ii) sus fuentes de financiación previstas para implementar su estrategia.', null),
  ('NIIF S2 16(d)', 'S2', 'estrategia', '6. Contenidos sobre los temas materiales', 'Cómo espera la entidad que cambien su rendimiento financiero y sus flujos de efectivo a corto, medio y largo plazo, teniendo en cuenta su estrategia para gestionar los riesgos y oportunidades relacionados con el clima.', null),
  ('NIIF S2 22(a)(i)', 'S2', 'estrategia', '6. Contenidos sobre los temas materiales', 'Las implicaciones, en su caso, de la evaluación de resiliencia climática para la estrategia y el modelo de negocio de la entidad, incluida la forma en que necesitaría responder a los efectos identificados en el análisis de escenarios relacionados con el clima.', null),
  ...
  ('NIIF S2 22(a)(iii)', 'S2', 'estrategia', '6. Contenidos sobre los temas materiales', 'La capacidad de la entidad para ajustar o adaptar su estrategia y su modelo de negocio al cambio climático a corto, medio y largo plazo, incluyendo la disponibilidad y flexibilidad de sus recursos financieros existentes, su capacidad de redistribuir, reutilizar, mejorar o desmantelar activos, y el efecto de sus inversiones actuales y planificadas en mitigación, adaptación y resiliencia climática.', null),
  ('NIIF S2 22(b)(i)', 'S2', 'estrategia', '6. Contenidos sobre los temas materiales', 'Información sobre los datos de entrada utilizados en el análisis de escenarios: qué escenarios y de qué fuentes, si el rango fue diverso, si se asocian a riesgos de transición o físicos, si se incluyó un escenario alineado con el último acuerdo internacional sobre cambio climático, por qué se consideran relevantes, los horizontes temporales empleados y el alcance de las operaciones analizadas.', null),
  ...
  ('NIIF S2 29 (a)(v)', 'S2', 'metricas', '6. Contenidos sobre los temas materiales', 'Para las emisiones de Alcance 2, revelar las emisiones basadas en la ubicación y proporcionar la información sobre cualquier instrumento contractual que sea necesaria para comprender el Alcance 2 de la entidad.', null),
  ('NIIF S2 29 (a)(vi)(1)', 'S2', 'metricas', '6. Contenidos sobre los temas materiales', 'Las categorías incluidas dentro de la medición de las emisiones de Alcance 3 de la entidad, conforme a las categorías de Alcance 3 descritas en la Norma de Contabilidad e Informes de la Cadena de Valor Corporativa (Alcance 3) del Protocolo de Gases de Efecto Invernadero (2011).', null),
  ...
  ('NIIF S2 29 (b)', 'S2', 'metricas', '6. Contenidos sobre los temas materiales', 'Riesgos de transición relacionados con el clima: la cantidad y el porcentaje de activos o actividades empresariales vulnerables a los riesgos de transición relacionados con el clima.', null),
  ('NIIF S2 29 (b) · B65 (b)', 'S2', 'metricas', '6. Contenidos sobre los temas materiales', 'Descripción de dónde se concentran en el modelo de negocio y en la cadena de valor de la entidad los riesgos de transición relacionados con el clima.', null),
  ('NIIF S2 29 (b) · B65 (c)', 'S2', 'metricas', '6. Contenidos sobre los temas materiales', 'Cómo los riesgos de transición relacionados con el clima han afectado a la situación financiera, el rendimiento financiero y los flujos de efectivo de la entidad durante el periodo sobre el que se informa.', null),
  ('NIIF S2 29 (c) · B65 (b)', 'S2', 'metricas', '6. Contenidos sobre los temas materiales', 'Descripción de dónde se concentran en el modelo de negocio y en la cadena de valor de la entidad los riesgos físicos relacionados con el clima.', null),
  ('NIIF S2 29 (c) · B65 (c)', 'S2', 'metricas', '6. Contenidos sobre los temas materiales', 'Cómo los riesgos físicos relacionados con el clima han afectado a la situación financiera, el rendimiento financiero y los flujos de efectivo de la entidad durante el periodo sobre el que se informa.', null),
  ('NIIF S2 29 (d)', 'S2', 'metricas', '6. Contenidos sobre los temas materiales', 'Oportunidades relacionadas con el clima: la cantidad y el porcentaje de activos o actividades empresariales alineadas con las oportunidades relacionadas con el clima.', null),
  ('NIIF S2 29 (d) · B65 (b)', 'S2', 'metricas', '6. Contenidos sobre los temas materiales', 'Descripción de dónde se concentran en el modelo de negocio y en la cadena de valor de la entidad las oportunidades relacionadas con el clima.', null),
  ('NIIF S2 29 (d) · B65 (c)', 'S2', 'metricas', '6. Contenidos sobre los temas materiales', 'Cómo las oportunidades relacionadas con el clima han afectado a su situación financiera, rendimiento financiero y flujos de efectivo durante el periodo sobre el que se informa', null),
  ...
  ('NIIF S2 29 (f) (i) y (ii)', 'S2', 'metricas', '6. Contenidos sobre los temas materiales', 'Precios internos del carbono: explicación de si la entidad aplica un precio del carbono en la toma de decisiones y cómo lo hace, y el precio por cada tonelada métrica de emisiones que utiliza para evaluar el costo de sus emisiones.', null),
  ('NIIF S2 29 (g) (i) y (ii)', 'S2', 'metricas', '6. Contenidos sobre los temas materiales', 'Remuneración: descripción de si las consideraciones relacionadas con el clima se tienen en cuenta en la remuneración de los ejecutivos y de qué manera, y el porcentaje de la remuneración de la gerencia ejecutiva reconocida en el periodo actual que está vinculada a consideraciones climáticas.', null),
  ('NIIF S2 30', 'S2', 'metricas', '6. Contenidos sobre los temas materiales', 'Al preparar la información a revelar para cumplir los requerimientos del párrafo 29(b) a (d), la entidad utilizará toda la información razonable y sustentable de que disponga en la fecha de presentación sin costo o esfuerzo desproporcionado.', null),
  ('NIIF S2 32', 'S2', 'metricas', '6. Contenidos sobre los temas materiales', 'Métricas basadas en el sector industrial asociadas con uno o más modelos de negocio, actividades u otros rasgos comunes que caractericen la participación en un sector industrial, considerando la Guía de Implementación de la NIIF S2 basada en Sectores Industriales.', null),
  ...
  ('NIIF S2 6 (a)(i)', 'S2', 'gobernanza', '3. Gobernanza', 'Cómo se reflejan las responsabilidades relativas a los riesgos y oportunidades relacionados con el clima en los términos de referencia, mandatos, descripciones de funciones y otras políticas relacionadas aplicables a dichos órganos o personas.', '16. Paz, justicia e instituciones sólidas'),
  ...
  ('NIIF S2 6 (a)(iii)', 'S2', 'gobernanza', '3. Gobernanza', 'Cómo y con qué frecuencia se informa a los órganos o personas sobre los riesgos y oportunidades relacionados con el clima.', null),
  ('NIIF S2 6 (a)(iv)', 'S2', 'gobernanza', '3. Gobernanza', 'Cómo tienen en cuenta los órganos o personas los riesgos y oportunidades relacionados con el clima al supervisar la estrategia de la entidad, sus decisiones sobre transacciones importantes y sus procesos de gestión de riesgos y políticas relacionadas, incluyendo si han considerado las compensaciones asociadas a esos riesgos y oportunidades.', null),
  ('NIIF S2 6 (a)(v)', 'S2', 'gobernanza', '3. Gobernanza', 'Cómo supervisan los órganos o personas el establecimiento de objetivos relacionados con los riesgos y oportunidades climáticos y cómo controlan los avances hacia su consecución (véanse los párrafos 33 a 36), incluyendo si las métricas de desempeño relacionadas se incluyen en las políticas de remuneración y de qué manera [véase el párrafo 29(g)].', '5. Igualdad de género 8. Trabajo decente y crecimiento económico'),
  ('NIIF S2 6(b)', 'S2', 'gobernanza', '4. Estrategia, políticas y prácticas', 'El papel de la gerencia en los procesos de gobernanza, los controles y los procedimientos utilizados para vigilar, gestionar y supervisar los riesgos y las oportunidades relacionados con el clima.', '16. Paz, justicia e instituciones sólidas'),
  ('NIIF S2 6(b)(i)', 'S2', 'gobernanza', '4. Estrategia, políticas y prácticas', 'Si la función se delega en un cargo específico a nivel de gerencia o en un comité a nivel de gerencia, y cómo se ejerce la supervisión sobre dicho cargo o comité.', null),
  ('NIIF S2 6(b)(ii)', 'S2', 'gobernanza', '4. Estrategia, políticas y prácticas', 'Si la gerencia utiliza controles y procedimientos para apoyar la supervisión de los riesgos y oportunidades relacionados con el clima y, en caso afirmativo, cómo se integran estos controles y procedimientos con otras funciones internas.', null),
...
from (values
  ...
  -- Riesgos físicos -> 29(c), NO 29(b). NIIF S2 29(b) son los riesgos de
  -- TRANSICIÓN y 29(c) los FÍSICOS; el enlace original apuntaba al de transición
  -- y hacía que el bloque 34 del suplemento se diera por cubierto con evidencia
  -- de otra cosa. El código de destino lo crea la auditoría del catálogo
  -- (docs/suplemento-s1s2/auditoria-catalogo.md).
  ('c0000000-0000-0000-0000-000000000011', 'NIIF S2 29 (c)'),
  ...
  ('c0000000-0000-0000-0000-000000000014', 'NIIF S2 29 (d)'), -- ingresos por productos/servicios sostenibles -> oportunidades climáticas: activos/actividades alineadas [DUDOSA]
